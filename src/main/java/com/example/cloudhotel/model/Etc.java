...
@SQLDelete(sql = "UPDATE TB_ETC SET DELETE_YN = 'Y', DELETE_TIME=TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS') WHERE ENO = ?")


public class Etc extends BaseTimeEntity{
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE
            , generator = "SQ_ETC_GENERATOR"
    )
    private Integer eno;
