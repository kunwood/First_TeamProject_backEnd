...
public abstract class BaseTimeEntity {
    ...
    //    실무 날짜 포맷 : yyyy-MM-dd HH:mm:ss
//    감시 함수 : 1) insert 하기전 실행되는 함수
//               2) update 하기전 실행되는 함수
    @PrePersist
        //해당 엔티티 저장하기 전
    void onPrePersist(){
        //        1) insert 하기전 실행되는 함수
//        LocalDateTime.now() : 현재날짜
//        .format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")) : 날짜포맷
