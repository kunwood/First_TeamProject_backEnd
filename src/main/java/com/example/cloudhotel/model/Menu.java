...
@Table(name="TB_MENU")
@SequenceGenerator(
        name = "SQ_MENU_GENERATOR"
        , sequenceName = "SQ_MENU"
        , initialValue = 1
        , allocationSize = 1
)
@Getter
...
@SQLDelete(sql = "UPDATE TB_MENU SET DELETE_YN = 'Y', DELETE_TIME=TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS') WHERE MNO = ?")

public class Menu extends BaseTimeEntity{
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE,
    generator = "SQ_MENU_GENERATOR")
    private Integer mno;
