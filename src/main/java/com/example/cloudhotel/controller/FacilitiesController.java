...
import com.example.cloudhotel.service.FacilitiesService;
...
public class FacilitiesController {
    ...
    public ResponseEntity<Object> getFacilitiesAll() {
//        에러 처리 : try ~ catch
        try {
//            1) 전체 조회 서비스 함수
            List<Facilities> list
                    = facilitiesService.findAll();
